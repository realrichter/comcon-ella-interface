...
const HeroSection: React.FC<HeroSectionProps> = ({ onStartConversation, currentLanguage }) => {
  const texts = {
    en: {
      ...
      description: 'Meet Ella, your AI-powered integration assistant. Ask about connecting your systems, automating workflows, or discovering how our Best Application Framework can revolutionize your operations.',
      features: [
    ...
    de: {
      ...
      description: 'Lernen Sie Ella kennen, Ihren KI-gesteuerten Integrations-Assistenten. Fragen Sie nach der Verbindung Ihrer Systeme, der Automatisierung von Workflows oder entdecken Sie, wie unser Best Application Framework Ihre Abläufe revolutionieren kann.',
      features: [
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden w-full">
      {/* Gradient Background - covers the whole viewport */}
      <div className="fixed inset-0 -z-10 bg-gradient-to-br from-slate-900 via-blue-900 to-purple-900">
